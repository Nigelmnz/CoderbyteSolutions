...
function CountingMinutesI(str) { 
  ...
  var time1 = (parseInt(data[1])*60 % 720) + parseInt(data[2]) + (data[3] === "pm" ? 60*12 : 0);
  var time2 = (parseInt(data[4])*60 % 720) + parseInt(data[5]) + (data[6] === "pm" ? 60*12 : 0);

  return (1440 + time2 - time1) % 1440;
}
